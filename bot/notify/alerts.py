...
Both are best-effort: a failed notification is logged and swallowed rather
than allowed to interrupt the scan/trade loop. Alerting should never be
able to take down trading.
"""
